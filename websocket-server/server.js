...
io.on("connection", (socket) => {
  ...
  const topics = [
    "Hobbies", "Favorite animals", "Favorite food", "Favorite movies",
    "Dream travel destinations", "Favorite books", "Music you listen to", "Favorite color",
    "Sports you enjoy", "World cuisines", "Weekend activities", "Childhood memories",
    "Favorite desserts", "Ideal vacation spot", "Favorite holidays or celebrations",
    "Daily routines", "Family traditions", "Favorite drinks", "Fun places to visit",
    "Favorite weather", "Future dreams or goals", "School or work experiences",
    "Favorite TV shows", "Favorite games or pastimes", "Pets you’ve had or want",
    "Your dream home", "Funny or embarrassing moments", "Favorite apps or websites",
    "Your bucket list", "New skills you’d like to learn", "Favorite childhood toys",
    "Books or movies that inspired you", "A place you’d like to live", "What makes you happy",
    "Favorite type of exercise", "Memorable travel experiences", "Things you collect or would like to collect",
    "Favorite ice cream flavors", "Favorite outdoor activities", "A special gift you’ve received",
    "Favorite clothes or fashion styles", "A talent or skill you have", "Best day of your life",
    "Favorite restaurant or café", "Your dream car", "Things you enjoy doing with friends",
    "How you relax after a long day", "Favorite childhood TV shows", "Your favorite holiday destination",
  ...
  socket.on("message", async (data) => {
    ...
    if (!chat[room]) {
      chat[room] = { messages: [], aiNickname: getRandomNickname() }; // Dodajemy unikalny nick dla AI
    }
